...
xcopy /E Text\*.* Pak128.Nordic\
copy Credits.txt Pak128.Nordic\Text\doc\*.*

echo Packing Misc-files
echo ==================

CD base\Big Logo
..\..\Makeobj-Extended PAK128 ../../Pak128.Nordic/ ./ >>..\..\err.txt

CD..\Misc_GUI_64
..\..\Makeobj-Extended PAK64 ../../Pak128.Nordic/ ./ >>..\..\err.txt
